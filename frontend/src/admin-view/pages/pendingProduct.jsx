...
const PendingProductComponent = () => {
    ...
    const getAllProductData = async () => {
        try {
            ...
            if (response.EC === 1) {
                // ⚡ Chỉ lấy danh sách sản phẩm chưa duyệt
                const sortedProducts = response.DT.inactiveProducts.sort(
                            ...
                            <tr key={product.masanpham}>
                                ...
                                <td className="d-flex align-items-center justify-content-between gap-1 func-button" style={{ border: 'none' }}>
                                    ...
                                    <button
                                        ...
                                        onClick={() => setOpenDelete(true) || setSelectedProduct(product)}
                                    >
...
export default PendingProductComponent;
